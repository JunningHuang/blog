...
document.addEventListener("DOMContentLoaded", () => {
    ...
    newScript.setAttribute('data-repo', 'JunningHuang/blog');
    newScript.setAttribute('data-repo-id', 'R_kgDOMOJ0mQ');
    newScript.setAttribute('data-category', 'Announcements');
    newScript.setAttribute('data-category-id', 'DIC_kwDOMOJ0mc4CglPO');
